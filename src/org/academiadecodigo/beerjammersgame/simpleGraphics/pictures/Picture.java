package org.academiadecodigo.beerjammersgame.simpleGraphics.pictures;

import org.academiadecodigo.beerjammersgame.simpleGraphics.graphics.Canvas;
import org.academiadecodigo.beerjammersgame.simpleGraphics.graphics.Color;
import org.academiadecodigo.beerjammersgame.simpleGraphics.graphics.Movable;
import org.academiadecodigo.beerjammersgame.simpleGraphics.graphics.Shape;
...
public class Picture implements Shape, Movable {
     ...
     */
    public org.academiadecodigo.beerjammersgame.simpleGraphics.graphics.Color getColorAt(int i) {
     ...
     */
    public void setColorAt(int i, org.academiadecodigo.beerjammersgame.simpleGraphics.graphics.Color color) {
        if (image == null || i < 0 || i >= pixels()) {
            throw new IndexOutOfBoundsException("" + i);
        } else {
     ...
     */
    public org.academiadecodigo.beerjammersgame.simpleGraphics.graphics.Color getColorAt(int x, int y) {
        if (image == null || x < 0 || x >= image.getWidth() || y < 0 || y >= image.getHeight()) {
            throw new IndexOutOfBoundsException("(" + x + "," + y + ")");
        } else {
            int rgb = image.getRGB(x, y) & 0xFFFFFF;
            return new org.academiadecodigo.beerjammersgame.simpleGraphics.graphics.Color(rgb / 65536, (rgb / 256) % 256, rgb % 256);
        }
    }
    ...
    public void setColorAt(int x, int y, Color color) {
        if (image == null || x < 0 || x >= image.getWidth() || y < 0 || y >= image.getHeight()) {
            ...
            org.academiadecodigo.beerjammersgame.simpleGraphics.graphics.Canvas.getInstance().repaint();
        }
    }
     ...
     */
    public void draw() {
        org.academiadecodigo.beerjammersgame.simpleGraphics.graphics.Canvas.getInstance().show(this);
    }
     ...
     */
    public void delete() {
        org.academiadecodigo.beerjammersgame.simpleGraphics.graphics.Canvas.getInstance().hide(this);
    }
