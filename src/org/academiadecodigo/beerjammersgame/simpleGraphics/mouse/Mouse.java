package org.academiadecodigo.beerjammersgame.simpleGraphics.mouse;
...
public class Mouse implements MouseListener, MouseMotionListener {
    ...
    /**
     * @see MouseHandler#mouseClicked(org.academiadecodigo.beerjammersgame.simpleGraphics.mouse.MouseEvent;)
     * @param e the event
     */
    @Override
    public void mouseClicked(MouseEvent e) {
        ...
        while (iterator.hasNext()) {
            ...
            if (et == MouseEventType.MOUSE_CLICKED) {
                handler.mouseClicked(new org.academiadecodigo.beerjammersgame.simpleGraphics.
                        mouse.MouseEvent(e.getX(), e.getY(), MouseEventType.MOUSE_CLICKED));
            }
    ...
    /**
     * @see MouseHandler#mouseMoved(org.academiadecodigo.beerjammersgame.simpleGraphics.mouse.MouseEvent)
     * @param e the event
     */
    @Override
    public void mouseMoved(MouseEvent e) {
        ...
        while (iterator.hasNext()) {
            ...
            if (et == MouseEventType.MOUSE_MOVED) {
                handler.mouseMoved(new org.academiadecodigo.beerjammersgame.simpleGraphics.
                        mouse.MouseEvent(e.getX(), e.getY(), MouseEventType.MOUSE_MOVED));
            }
